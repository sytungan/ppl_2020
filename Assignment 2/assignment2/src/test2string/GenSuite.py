...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_307(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("r"),[],IntLiteral(2)),VarDecl(Id("c"),[],IntLiteral(9))],[Assign(Id("r"),BinaryOp("+",Id("r"),Id("c"))),Assign(Id("r"),BinaryOp("-",IntLiteral(9),Id("r"))),Return(BooleanLiteral(True))]))])
    ...
    def test_308(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("r"),[],None),VarDecl(Id("d"),[],None),VarDecl(Id("t"),[],None)],[Assign(Id("r"),FloatLiteral(3.14)),Assign(Id("s"),BinaryOp("+",BinaryOp("*",Id("r"),Id("r")),IntLiteral(2))),Assign(Id("t"),BinaryOp("=/=",BinaryOp("||",BinaryOp("&&",Id("s"),UnaryOp("!",CallExpr(Id("foo"),[IntLiteral(2)]))),Id("r")),BinaryOp("&&",FloatLiteral(9.0),BinaryOp("*.",BinaryOp("+",IntLiteral(2),IntLiteral(3)),FloatLiteral(5.0))))),Assign(Id("t"),BinaryOp("\.",Id("t"),FloatLiteral(3.0))),Return(BooleanLiteral(True))]))])
    ...
    def test_310(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("r"),[],FloatLiteral(3.14)),VarDecl(Id("t"),[],None)],[Assign(Id("r"),BinaryOp("==",BinaryOp("*",Id("r"),Id("r")),BinaryOp("*",IntLiteral(2),IntLiteral(3)))),Assign(Id("t"),BooleanLiteral(True)),Assign(Id("t"),BinaryOp("==",UnaryOp("!",Id("t")),UnaryOp("!",BinaryOp("||",BinaryOp("&&",Id("r"),BooleanLiteral(False)),BinaryOp("-",IntLiteral(2),IntLiteral(2))))))]))])
    ...
    def test_315(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[VarDecl(Id("x"),[],None)],([VarDecl(Id("x"),[],IntLiteral(0))],[While(BinaryOp("<",Id("i"),IntLiteral(10)),([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),If([(BinaryOp("==",Id("i"),Id("x")),[],[Break()])],()),CallStmt(Id("writeln"),[Id("i")])]))]))])
    ...
    def test_317(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("a"),[2,3,4,5],None)],[Dowhile(([],[Assign(Id("a"),FloatLiteral(2e+59)),Assign(Id("e"),FloatLiteral(0.0))]),BooleanLiteral(True)),CallStmt(Id("writeln"),[BinaryOp("-.",Id("a"),Id("e"))])]))])
    ...
    def test_323(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("x"),[],IntLiteral(1))],[While(UnaryOp("!",Id("x")),([],[Assign(Id("x"),BinaryOp("||",BooleanLiteral(True),BooleanLiteral(False))),Continue()]))]))])
    ...
    def test_326(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("i"),[],IntLiteral(0))],[Dowhile(([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),CallStmt(Id("writeln"),[Id("i")])]),BinaryOp("<",Id("i"),IntLiteral(10)))]))])
    ...
    def test_328(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("n"),[],IntLiteral(0)),VarDecl(Id("s"),[],IntLiteral(0))],[Dowhile(([],[Assign(Id("n"),BinaryOp("+",Id("n"),IntLiteral(1))),Assign(Id("s"),BinaryOp("+",Id("s"),Id("n"))),Dowhile(([],[If([(BinaryOp("==",BinaryOp("%",Id("n"),IntLiteral(2)),IntLiteral(0)),[],[Assign(Id("s"),BinaryOp("+",Id("s"),IntLiteral(1)))])],())]),BinaryOp("<",Id("s"),IntLiteral(1000)))]),BinaryOp("<",BinaryOp("+",BinaryOp("+",Id("s"),Id("n")),IntLiteral(1)),Id("max"))),CallStmt(Id("writeln"),[Id("n")])]))])
    ...
    def test_329(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("i"),[],None),VarDecl(Id("j"),[],None),VarDecl(Id("k"),[],None),VarDecl(Id("l"),[],None)],[Dowhile(([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),While(BinaryOp("<",Id("j"),IntLiteral(100)),([],[Assign(Id("j"),BinaryOp("+",Id("j"),IntLiteral(3))),Dowhile(([],[Assign(Id("k"),BinaryOp("+",Id("k"),IntLiteral(1))),While(BinaryOp("<",Id("l"),IntLiteral(100)),([],[Assign(Id("l"),BinaryOp("+",Id("l"),IntLiteral(2)))]))]),BinaryOp("<",Id("k"),IntLiteral(100)))]))]),BinaryOp("<",BinaryOp("+",BinaryOp("+",BinaryOp("+",Id("i"),Id("j")),Id("k")),Id("l")),CallExpr(Id("foo"),[IntLiteral(2)]))),CallStmt(Id("writeln"),[Id("n")])]))])
    ...
    def test_330(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[VarDecl(Id("n"),[],None)],([VarDecl(Id("flag"),[],IntLiteral(0))],[Dowhile(([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),If([(BinaryOp("&&",BinaryOp("!=",Id("n"),IntLiteral(2)),BinaryOp("==",BinaryOp("%",Id("n"),Id("i")),IntLiteral(0))),[],[Assign(Id("flag"),IntLiteral(1))])],())]),BinaryOp("<=",Id("i"),CallExpr(Id("sqrt"),[Id("n")]))),CallStmt(Id("print"),[Id("i")])]))])
    ...
    def test_337(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([],[For(Id("i"),IntLiteral(0),BinaryOp("<=",Id("i"),BinaryOp("\\",IntLiteral(1000),IntLiteral(10))),IntLiteral(1),([],[If([(BinaryOp("==",BinaryOp("%",Id("i"),IntLiteral(2)),IntLiteral(0)),[],[CallStmt(Id("writeln"),[BinaryOp("\\",Id("i"),IntLiteral(2))])])],())]))]))])
    ...
    def test_342(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("a"),[],IntLiteral(2))],[For(Id("i"),BinaryOp("-",IntLiteral(10),BinaryOp("\\",BinaryOp("*",Id("a"),Id("a")),IntLiteral(2))),BinaryOp("<",Id("a"),IntLiteral(100)),BinaryOp(">",Id("a"),BinaryOp("+",Id("a"),IntLiteral(1))),([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),CallStmt(Id("writeln"),[BinaryOp("-",BinaryOp("*",Id("a"),Id("a")),BinaryOp("*",Id("i"),Id("i")))])]))]))])
    ...
    def test_343(self):
        ...
        Body:
            ...
            For (i = 1, i < n, 1) Do
                Do  
                    While !False Do
                        p_V0 = t*t;
                        p_V1 = a + c*t\2 -. 9.e5 +. 2. - 2%2 \. 2;
                        p_V2 = c*c*c - p_V0*(2%2) - 19e5 *.2 -. 1. --6 + p_V1*99999; 
                        s = False; 
                    EndWhile.
        ...
        EndBody.
        """ 
        expect = Program([VarDecl(Id("a"),[100,100],ArrayLiteral([ArrayLiteral([FloatLiteral(6.409e+22),FloatLiteral(12.0),FloatLiteral(9.235)]),ArrayLiteral([StringLiteral("abc"),ArrayLiteral([ArrayLiteral([IntLiteral(3873),IntLiteral(2748)]),ArrayLiteral([FloatLiteral(212.409),FloatLiteral(2.0)]),IntLiteral(72215)]),IntLiteral(2)]),ArrayLiteral([FloatLiteral(9.0),ArrayLiteral([ArrayLiteral([IntLiteral(3),IntLiteral(2)]),ArrayLiteral([FloatLiteral(4.0),StringLiteral("cdf")]),ArrayLiteral([IntLiteral(10),ArrayLiteral([IntLiteral(64),IntLiteral(99)])])]),StringLiteral("hi")])])),VarDecl(Id("c"),[],None),FuncDecl(Id("test"),[VarDecl(Id("n"),[],None)],([VarDecl(Id("t"),[],FloatLiteral(5432.0)),VarDecl(Id("s"),[],None),VarDecl(Id("r"),[],None),VarDecl(Id("a"),[],FloatLiteral(4.2)),VarDecl(Id("c"),[],IntLiteral(3)),VarDecl(Id("p_V"),[3],None)],[For(Id("i"),IntLiteral(1),BinaryOp("<",Id("i"),Id("n")),IntLiteral(1),([],[If([(BinaryOp("==",Id("i"),BinaryOp("\\",Id("n"),IntLiteral(2))),[],[Break()])],()),Dowhile(([],[Assign(Id("s"),BinaryOp("=/=",BinaryOp("&&",BinaryOp("&&",BinaryOp("||",UnaryOp("!",Id("s")),UnaryOp("!",BinaryOp("==",Id("s"),IntLiteral(2)))),BinaryOp(">=.",Id("t"),FloatLiteral(5432.0))),Id("t")),BinaryOp("*.",Id("t"),IntLiteral(2)))),While(UnaryOp("!",BooleanLiteral(False)),([],[Assign(Id("p_V0"),BinaryOp("*",Id("t"),Id("t"))),Assign(Id("p_V1"),BinaryOp("-",BinaryOp("+.",BinaryOp("-.",BinaryOp("+",Id("a"),BinaryOp("\\",BinaryOp("*",Id("c"),Id("t")),IntLiteral(2))),FloatLiteral(900000.0)),FloatLiteral(2.0)),BinaryOp("\.",BinaryOp("%",IntLiteral(2),IntLiteral(2)),IntLiteral(2)))),Assign(Id("p_V2"),BinaryOp("+",BinaryOp("-",BinaryOp("-.",BinaryOp("-",BinaryOp("-",BinaryOp("*",BinaryOp("*",Id("c"),Id("c")),Id("c")),BinaryOp("*",Id("p_V0"),BinaryOp("%",IntLiteral(2),IntLiteral(2)))),BinaryOp("*.",FloatLiteral(1900000.0),IntLiteral(2))),FloatLiteral(1.0)),UnaryOp("-",IntLiteral(6))),BinaryOp("*",Id("p_V1"),IntLiteral(99999)))),Assign(Id("s"),BooleanLiteral(False))])),Break()]),BooleanLiteral(True))])),Return(CallExpr(Id("test"),[BinaryOp("%",Id("n"),IntLiteral(2))]))])),FuncDecl(Id("main"),[],([],[CallStmt(Id("test"),[Id("n")])]))])
    ...
    def test_346(self):
        ...
        Body:
            For (i = 0 , i < arr , 1) Do
                ...
                Else 
                    While !False Do
                        If (!False == True) Then print((foo(i*i+111)\foo(foo(arr*i\2))));
                        Else Continue;
                        EndIf.    
                    EndWhile.
                EndIf.
    ...
    def test_352(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("x"),[],IntLiteral(10)),VarDecl(Id("a"),[10],None)],[Assign(Id("x"),BinaryOp("+",Id("x"),IntLiteral(1)))]))])
    ...
    def test_354(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("hi"),[],([VarDecl(Id("s"),[],StringLiteral("hi_hi"))],[Assign(Id("s"),StringLiteral("nice"))]))])
    ...
    def test_355(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[VarDecl(Id("x"),[],None)],([],[Assign(Id("x"),BinaryOp("\\",BinaryOp("-",Id("x"),IntLiteral(1)),IntLiteral(2)))]))])
    ...
    def test_356(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test___1"),[VarDecl(Id("a"),[],None),VarDecl(Id("b"),[],None),VarDecl(Id("c"),[],None),VarDecl(Id("d"),[],None)],([VarDecl(Id("c"),[],IntLiteral(5))],[]))])
    ...
    def test_357(self):
        ...
        .
        """ 
        expect = Program([FuncDecl(Id("foo"),[VarDecl(Id("a"),[5],None),VarDecl(Id("b"),[],None)],([VarDecl(Id("i"),[],IntLiteral(0))],[Return(IntLiteral(1))]))])
    ...
    def test_366(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("math"),[],IntLiteral(10)),VarDecl(Id("literature"),[],IntLiteral(6)),VarDecl(Id("english"),[],IntLiteral(8)),VarDecl(Id("avg"),[],None),VarDecl(Id("raise"),[],None)],[Assign(Id("avg"),BinaryOp("\\",BinaryOp("+",BinaryOp("+",Id("math"),Id("literature")),Id("english")),IntLiteral(3))),If([(BinaryOp("<",Id("avg"),IntLiteral(3)),[],[Assign(Id("raise"),StringLiteral("Hoc lai"))]),(BinaryOp("<",Id("avg"),IntLiteral(4)),[],[Assign(Id("raise"),StringLiteral("Yeu"))]),(BinaryOp("<.",Id("avg"),FloatLiteral(6.5)),[],[Assign(Id("raise"),StringLiteral("TB"))]),(BinaryOp("<.",Id("avg"),FloatLiteral(8.0)),[],[Assign(Id("raise"),StringLiteral("Kha"))]),(BinaryOp("<.",Id("avg"),FloatLiteral(9.0)),[],[Assign(Id("raise"),StringLiteral("Gioi"))])],([],[Assign(Id("raise"),StringLiteral("Xuat sac"))]))]))])
    ...
    def test_371(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([],[Return(BooleanLiteral(True))]))])
    ...
    def test_389(self):
        ...
        expect = Program([VarDecl(Id("x"),[5],ArrayLiteral([IntLiteral(1),IntLiteral(2),StringLiteral("h"),FloatLiteral(2e+56),StringLiteral("")])),VarDecl(Id("y"),[],FloatLiteral(12.0))])
    ...
    def test_390(self):
        ...
        EndBody.
        """ 
        expect = Program([VarDecl(Id("a"),[],None),FuncDecl(Id("test"),[],([],[Return(None)]))])
    ...
    def test_403(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("x"),[],None),VarDecl(Id("y__"),[],None),VarDecl(Id("z23"),[],None),VarDecl(Id("t_12"),[],None)],[]))])
    ...
    def test_409(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("x"),[],IntLiteral(0))],[While(BinaryOp("<",Id("i"),IntLiteral(10)),([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),CallStmt(Id("writeln"),[Id("i")])]))]))])
    ...
    def test_412(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("outer"),[],IntLiteral(1))],[While(BinaryOp("<=",Id("outer"),IntLiteral(5)),([VarDecl(Id("inner"),[],IntLiteral(1))],[Assign(Id("outer"),BinaryOp("+",Id("outer"),IntLiteral(1))),While(BinaryOp("<=",Id("inner"),IntLiteral(5)),([],[Assign(Id("inner"),BinaryOp("+",Id("inner"),IntLiteral(1))),CallStmt(Id("print"),[Id("inner")])]))]))]))])
    ...
    def test_414(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[VarDecl(Id("m"),[],None),VarDecl(Id("n"),[],None),VarDecl(Id("o"),[],None),VarDecl(Id("p"),[],None)],([VarDecl(Id("x"),[],None)],[While(BinaryOp("<=",Id("m"),IntLiteral(2)),([],[Assign(Id("x"),BinaryOp("*",BinaryOp("*",BinaryOp("*",Id("m"),Id("n")),Id("p")),Id("o"))),Assign(Id("m"),BinaryOp("+",Id("m"),IntLiteral(1))),While(BinaryOp(">=",Id("n"),IntLiteral(1)),([],[Assign(Id("x"),BooleanLiteral(True)),Assign(Id("n"),BinaryOp("-",Id("n"),IntLiteral(1))),While(BinaryOp("<=",Id("o"),Id("n")),([],[Assign(Id("o"),BinaryOp("-",Id("o"),IntLiteral(1))),While(BinaryOp("<=",Id("p"),IntLiteral(2)),([],[Assign(Id("p"),BinaryOp("+",Id("p"),IntLiteral(1)))]))]))]))]))]))])
    ...
    def test_415(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("test"),[],([VarDecl(Id("i"),[],None),VarDecl(Id("arr"),[100,100],None)],[While(BinaryOp("<",Id("i"),IntLiteral(100)),([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),For(Id("j"),IntLiteral(1),BinaryOp("<",Id("j"),IntLiteral(100)),IntLiteral(1),([],[Assign(ArrayCell(Id("arr"),[Id("i"),Id("j")]),IntLiteral(1))]))]))]))])
    ...
    def test_417(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("sNum"),[VarDecl(Id("n"),[],None)],([VarDecl(Id("i"),[],IntLiteral(0))],[While(BinaryOp("<=",BinaryOp("*",Id("i"),Id("i")),Id("n")),([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1))),If([(BinaryOp("==",BinaryOp("*",Id("i"),Id("i")),Id("n")),[],[CallStmt(Id("writeln"),[Id("n")]),Return(None)])],())]))]))])
